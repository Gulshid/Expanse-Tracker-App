...
import com.gulshid.expensetracker.ui.auth.LoginFragment;
import com.gulshid.expensetracker.ui.auth.RegisterFragment;
...
public final class DaggerExpenseTrackerApp_HiltComponents_SingletonC {
  ...
  public static ExpenseTrackerApp_HiltComponents.SingletonC create() {
  ...
  private static final class FragmentCImpl extends ExpenseTrackerApp_HiltComponents.FragmentC {
    ...
    @Override
    public void injectAddExpenseFragment(AddExpenseFragment arg0) {
    }
    ...
    private DashboardFragment injectDashboardFragment2(DashboardFragment instance) {
      DashboardFragment_MembersInjector.injectFirebaseAuth(instance, singletonCImpl.provideFirebaseAuthProvider.get());
      return instance;
    }
  }
  ...
  private static final class ActivityCImpl extends ExpenseTrackerApp_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>of(LazyClassKeyProvider.com_gulshid_expensetracker_ui_auth_AuthViewModel, AuthViewModel_HiltModules.KeyModule.provide(), LazyClassKeyProvider.com_gulshid_expensetracker_ui_expense_ExpenseViewModel, ExpenseViewModel_HiltModules.KeyModule.provide()));
    }
  ...
  private static final class ViewModelCImpl extends ExpenseTrackerApp_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>of(LazyClassKeyProvider.com_gulshid_expensetracker_ui_auth_AuthViewModel, ((Provider) authViewModelProvider), LazyClassKeyProvider.com_gulshid_expensetracker_ui_expense_ExpenseViewModel, ((Provider) expenseViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.gulshid.expensetracker.data.repository.AuthRepositoryImpl 
